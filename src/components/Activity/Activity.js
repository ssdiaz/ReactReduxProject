        ...
        return(
            <div className="card w-50">
                <div className="card-body">
                    ...
                    {this.state.displayActivityInput === true  ?  <Redirect to={`/trips/${activity.trip_id}/activities/${activity.id}/edit`} render ={<ActivityInput trip={this.props.trip} />} />  :  <Redirect to={`/trips/${activity.trip_id}`} /> } 
                </div>
            </div>
        )
    }
